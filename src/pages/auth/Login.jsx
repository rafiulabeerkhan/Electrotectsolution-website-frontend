          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              <div className="mb-2 block">
                <Label htmlFor="email" value="Email address" className="text-text dark:text-text-dark font-medium" />
              </div>
              <TextInput
                id="email"
                type="email"
            ...
            <div>
              <div className="mb-2 block">
                <Label htmlFor="password" value="Password" className="text-text dark:text-text-dark font-medium" />
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Checkbox id="remember" className="text-primary-600 focus:ring-primary-500" />
                <Label htmlFor="remember" className="text-text-light dark:text-text-dark-light text-sm cursor-pointer">
                  Remember me
                </Label>
              </div>

              <div className="text-sm">
                <a href="#" className="font-medium text-primary-600 hover:text-primary-500 dark:text-sidebar-text dark:hover:text-primary-300 transition-colors">
                  Forgot password?
                </a>
              </div>
            </div>
